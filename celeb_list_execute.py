...
file_to_execute = "E:/Projects/Frido/wikimedia webscraper.py"

celeb_list = ["Beyoncé Knowles","Jackie Chan","Greta Thunberg","Lionel Messi","Deepika Padukone","Samuel L. Jackson","Angela Merkel","Malala Yousafzai",
